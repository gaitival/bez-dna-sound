...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Your Digital Sound Journey is a landing page that showcases a unique digital product and directs users to a Telegram bot for purchases." },
      { property: "og:description", content: "Your Digital Sound Journey is a landing page that showcases a unique digital product and directs users to a Telegram bot for purchases." },
      { name: "twitter:description", content: "Your Digital Sound Journey is a landing page that showcases a unique digital product and directs users to a Telegram bot for purchases." },
