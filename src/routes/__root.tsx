...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Древо трансформации из 27 ступеней и звуковые протоколы под твою ДНК. Персональный разбор по дате рождения. Старт — в Telegram" },
      { property: "og:description", content: "Древо трансформации из 27 ступеней и звуковые протоколы под твою ДНК. Персональный разбор по дате рождения. Старт — в Telegram" },
      { name: "twitter:description", content: "Древо трансформации из 27 ступеней и звуковые протоколы под твою ДНК. Персональный разбор по дате рождения. Старт — в Telegram" },
