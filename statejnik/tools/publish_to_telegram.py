...
def main():
    ...
    caption_lines = [
        ...
        f"{description}",
        "",
        "<i>5-минутный звуковой трек, визуальный ключ и соматическая инструкция. Доступ навсегда от 250 звёзд (действуют скидки при заказе).</i>",
        "",
        "🌐 <a href=\"https://bez-dna-sound.com\">https://bez-dna-sound.com</a>"
    ]
