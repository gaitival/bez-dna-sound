# Чек-лист статьи «Скилла статей» - `reka-smorodina-ostav-imya-na-beregu`
...
- [x] 1.2 Выбор КОД 25 «Река Смородина: оставь имя на берегу»
...
- [x] 6b.5 Сохранено в `/images/blog/reka-smorodina.webp`
- [x] 6b.6 Alt-текст
