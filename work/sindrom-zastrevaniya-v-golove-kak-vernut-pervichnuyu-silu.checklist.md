# Чек-лист статьи «Скилла статей» - `sindrom-zastrevaniya-v-golove-kak-vernut-pervichnuyu-silu`
...
- [x] 1.1 Поиск неохваченных тем
- [x] 1.2 Выбор КОД 17 «Первичная сила»
...
- [x] 6.2 Тело статьи в `work/<slug>/draft.md` (вариативное начало, без «Вы»)
...
- [x] 6a.1 ТОЧКА 1
- [x] 6a.2 ТОЧКА 2
- [x] 6a.3 ТОЧКА 3 (абзац ценности без отдельного заголовка H2)
...
- [x] 6b.5 Сохранено в `/images/blog/pervichnaya-sila.webp`
- [x] 6b.6 Alt-текст
