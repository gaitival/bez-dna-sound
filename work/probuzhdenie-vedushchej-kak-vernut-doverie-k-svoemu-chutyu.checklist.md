# Чек-лист статьи «Скилла статей» - `probuzhdenie-vedushchej-kak-vernut-doverie-k-svoemu-chutyu`
...
- [x] SKIP: тема задана явно «КОД 19 Пробуждение ведьмы», переход к Этапу 3
...
- [x] 6b.5 Сохранено в `/images/blog/probuzhdenie-vedmy.webp`
- [x] 6b.6 Alt-текст
