# Чек-лист статьи «Скилла статей» - `sindrom-nevidimki-pochemu-vas-ne-zamechayut-i-kak-vklyuchit-otklik`
...
- [x] 1.2 Выбор КОД 08 «Высокий отклик»
...
- [x] 6b.5 Сохранено в `/images/blog/vysokij-otklik.webp`
- [x] 6b.6 Alt-текст
